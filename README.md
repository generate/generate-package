...
Running `$ gen package` will run the generator's [default task](#default), which will:
...
### [package:choose](generator.js#L113)
...
### [package:package-hints](generator.js#L134)
